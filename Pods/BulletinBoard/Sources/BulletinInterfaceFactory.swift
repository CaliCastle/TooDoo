...
//        titleLabel.font = UIFont.systemFont(ofSize: titleFontSize, weight: UIFontWeightMedium)
        titleLabel.font = UIFont(name: "AvenirNext-Bold", size: titleFontSize)
...
//        descriptionLabel.font = UIFont.systemFont(ofSize: fontSize)
        descriptionLabel.font = UIFont(name: "AvenirNext-Regular", size: fontSize)
...
//        actionButton.titleLabel?.font = UIFont.systemFont(ofSize: actionButtonFontSize, weight: UIFontWeightSemibold)
        actionButton.titleLabel?.font = UIFont(name: "AvenirNext-DemiBold", size: actionButtonFontSize)
    ...
    public func makeAlternativeButton(title: String) -> UIButton {
        ...
        alternativeButton.titleLabel?.font = UIFont(name: "AvenirNext-Regular", size: UIFont.systemFontSize)
