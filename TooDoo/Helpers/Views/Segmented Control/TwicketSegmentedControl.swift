...
struct TwicketPalette {
    
    static let defaultTextColor = TwicketPalette.colorFromRGB(9, green: 26, blue: 51, alpha: 0.4)
    static let highlightTextColor = UIColor.white
    static let segmentedControlBackgroundColor = TwicketPalette.colorFromRGB(237, green: 242, blue: 247, alpha: 0.7)
    static let sliderColor = TwicketPalette.colorFromRGB(44, green: 131, blue: 255)
...
open class TwicketSegmentedControl: UIControl {
    ...
    open var defaultTextColor: UIColor = TwicketPalette.defaultTextColor {
        didSet {
            updateLabelsColor(with: defaultTextColor, selected: false)
        }
    }

    open var highlightTextColor: UIColor = TwicketPalette.highlightTextColor {
        didSet {
            updateLabelsColor(with: highlightTextColor, selected: true)
        }
    }

    open var segmentsBackgroundColor: UIColor = TwicketPalette.segmentedControlBackgroundColor {
        didSet {
            backgroundView.backgroundColor = segmentsBackgroundColor
        }
    }

    open var sliderBackgroundColor: UIColor = TwicketPalette.sliderColor {
        didSet {
